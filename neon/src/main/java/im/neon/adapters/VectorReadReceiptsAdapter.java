...
public class VectorReadReceiptsAdapter extends ArrayAdapter<ReceiptData> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SpannableStringBuilder body = new SpannableStringBuilder(mContext.getString(im.neon.R.string.read_receipt) + " : " + ts);
        body.setSpan(new android.text.style.StyleSpan(android.graphics.Typeface.BOLD), 0, mContext.getString(im.neon.R.string.read_receipt).length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
