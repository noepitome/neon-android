...
import im.neon.PublicRoomsManager;
import im.neon.R;
import im.neon.ViewedRoomTracker;
import im.neon.activity.CommonActivityUtils;
import im.neon.activity.VectorPublicRoomsActivity;
import im.neon.activity.VectorRoomActivity;
import im.neon.adapters.VectorRoomSummaryAdapter;
import im.neon.services.EventStreamService;
import im.neon.view.RecentsExpandableListView;
