...
public class VideoRecordProgressView extends View {
    ...
    private void refreshColor() {
        if (0 == mRoundCount) {
            ...
            mPowerColor = getResources().getColor((0 == mod) ? im.neon.R.color.vector_silver_color :  android.R.color.white);
            mRestColor = getResources().getColor((0 != mod) ? im.neon.R.color.vector_silver_color :  android.R.color.white);
        }
    }
