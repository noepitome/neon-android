...
public class VideoRecordView extends RelativeLayout {
    ...
    private void initView() {
        View.inflate(getContext(), im.neon.R.layout.video_record_view, this);

        // retrieve the UI items
        mVideoRecordProgressView = (VideoRecordProgressView) findViewById(im.neon.R.id.video_record_progress_view);
    }
