            ...
            new AlertDialog.Builder(VectorApp.getCurrentActivity())
                    ...
                    .setNeutralButton(R.string.disable, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            editor.putBoolean(mContext.getString(im.neon.R.string.settings_key_use_rage_shake), false);
                            editor.commit();
            ...
            if (timeDiff > 0) {
                ...
                if (Float.compare(force, mThreshold) > 0) {
                    if (((now - mLastShake) >= mIntervalNanos) && ((System.currentTimeMillis() - mLastShakeTimestamp) > mTimeToNextShakeMs)) {
                        ...
                        if (preferences.getBoolean(mContext.getString(im.neon.R.string.settings_key_use_rage_shake), true)) {
                            promptForReport();
                        }
                    }
                    else {
